...
from engine.trainer_idea import do_train, do_train_with_center
from modeling import build_idea_model
...
def train(cfg):
    ...
    # prepare model
    model = build_idea_model(cfg, num_classes)
